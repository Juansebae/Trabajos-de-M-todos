...
void InicieAnimacion(void){
  ...
  cout<<"set output 'cubo_modificado_2.gif'"<<endl;
  cout<<"unset key"<<endl;
  cout<<"set xrange [-60:60]"<<endl;
  cout<<"set yrange [-60:60]"<<endl;
  cout<<"set zrange [-60:12]"<<endl;
  
  //cout<<"set term gif size 900,700"<<endl;                //Este es el motivo por el cual no sale End of animation Secuence!!
