...
void Mercado::HagaTransaccionEntre(Agente & Agente1,Agente & Agente2,Crandom & ran64){
  ...
  Resultado=2*ran64.r();
  GananciaAgente1=Resultado-1;
  GananciaAgente2=(2-Resultado)-1;
  ...
  Agente1.dinero=NuevoDineroAgente1;
  Agente2.dinero=NuevoDineroAgente2;
  }
...
int main(void){
  ...
  // Inicie todos los Agentes con 10 pesos
  for(i=0;i<N;i++){Paisano[i].Inicie(10);}
  
  for(t=0;t<Ntransacciones;t++){

    // Escogo dos agentes al azar.
    i=(int)N*ran64.r();
